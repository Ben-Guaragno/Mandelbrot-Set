...
public class Menu extends MouseAdapter {
	...
	public void mousePressed(MouseEvent e){
		...
		if(game.gameState==STATE.Menu){
			if(mouseOver(mx, my, game.getWindow().getFrame().getWidth()/2-50, 300, 100, 64)){
...
//		Font fnt3=new Font("arial",1,15);
		...
		if(game.gameState==STATE.Menu){
			...
			Game.drawCenteredString(g, "Start", new Rectangle(game.getWindow().getFrame().getWidth()/2-50, 300,100,64), fnt2);
			...
			g.drawRect(game.getWindow().getFrame().getWidth()/2-50, 300, 100, 64);
		}
		else if(game.gameState==STATE.Select){
